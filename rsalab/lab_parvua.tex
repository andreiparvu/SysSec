...
\begin{figure} \centering{
  \includegraphics[width=0.5\linewidth]{pics/print_000.png}}
  \caption{Initial two second measurement.}
  \label{fig00}
\end{figure}
\begin{figure} \centering{
  \includegraphics[width=0.5\linewidth]{pics/print_001.png}}
  \caption{Two second measurement cleaned up via averaging.}
  \label{fig01}
\end{figure}
\begin{figure} \centering{
  \includegraphics[width=0.5\linewidth]{pics/print_002.png}}
  \caption{LSBs of the public exponent.}
  \label{fig02}
\end{figure}
\begin{figure} \centering{
  \includegraphics[width=0.5\linewidth]{pics/print_003.png}}
